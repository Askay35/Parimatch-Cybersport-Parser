...
def getEvents():
    ...
    cb = WebDriverWait(driver, 30).until(ec.presence_of_element_located((By.XPATH, "//label[@class='p5_p n7_n9']/input[@class='p5_p7']")))
    ...
    while(True):
        ...
        time.sleep(3)
        new_events = len(driver.find_elements_by_class_name(event_class))
    ...
    return driver.find_elements_by_class_name(event_class)
